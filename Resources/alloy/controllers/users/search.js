function Controller() {
    ...
    $.__views.__alloyId131 = Ti.UI.createTableView({
        backgroundColor: "#fff",
    ...
    $.__views.__alloyId133.add($.__views.search);
    ...
    $.__views.__alloyId133.add($.__views.execute);
    $.__views.__alloyId131.headerView = $.__views.__alloyId133;
