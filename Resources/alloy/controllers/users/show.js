function Controller() {
    ...
    $.__views.__alloyId134 = Ti.UI.createTableView({
        backgroundColor: "#fff",
    ...
    $.__views.__alloyId136.add($.__views.search);
    ...
    $.__views.__alloyId136.add($.__views.execute);
    $.__views.__alloyId134.headerView = $.__views.__alloyId136;
